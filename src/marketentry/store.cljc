(ns marketentry.store
  "SSoT for the PRT market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems PT" :portal "BASE.gov.pt"
             ...
             :jurisdiction "PRT" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "BASE.gov.pt"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-nif? true :nif-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "BASE.gov.pt"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "PRT" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "BASE.gov.pt"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "PRT" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "BASE.gov.pt"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "PRT" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "BASE.gov.pt"
